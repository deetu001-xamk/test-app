...
export const LoginPage = () => {
    ...
    <div className='flex min-h-full flex-1 flex-col justify-center px-5 py-10'>
            <div className='mx-auto w-full max-w-sm'>
                ...
                <h1 className='mt-8 text-center text-2xl font-bold text-gray-800'
                >Kirjaudu sisään</h1>
            </div>
                ...
                <form className='space-y-5'>
                    ...
                    <div>
                        <div className='flex items-center justify-between'>
                            ...
                            <div className='text-sm'>
                                <a className='font-semibold text-indigo-600 hover:text-indigo-400' href='#'>Unohtuiko salasana?</a>
                            </div>
                        </div>
                        <div>
                            <input
                    ...
                    <div>
                        <button className='
                                            ...
                                            shadow-xl hover:bg-indigo-500 hover:cursor-pointer  
                                ' type='submit'>
                        Kirjaudu sisään
                        </button>
                    </div>
